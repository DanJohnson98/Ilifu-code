...
##################### Setting up the lens models ##########################################3
    ...
    image_sim_EQ = image_sim_EQ + bkg
    poisson = image_util.add_poisson(image_sim_EQ, exp_time=exp_time)
    image_sim_EQ = image_sim_EQ + poisson
